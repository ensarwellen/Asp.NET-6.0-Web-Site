...
namespace BitirmeMovieStore.Repositories.Implementation
{
    public class MovieService : IMovieService
    {
        public readonly DatabaseContext ctx;
        ...
        public MovieListVm List(string term="", bool paging=false, int currentPage=0) //başta false veriyoruz çünkü admin panelinde sayfalama yapmadığımız halde bu metodu kullanıyoruz.
        {
        ...
        public bool Update(Movie model)
        {
            try
            {
                //Bu genreId'ler kullanıcı tarafından seçilmediği halde hala edit ekranında görünüyordu. Bu Id'leri de kaldırıyoruz.
